...
import { BaseClientSideWebPart, IPropertyPaneField } from '@microsoft/sp-webpart-base';

import * as strings from 'LocalizedWebPartStrings';
import Localized from './components/Localized';
import { ILocalizedProps } from './components/ILocalizedProps';
import { SPHttpClientResponse, SPHttpClient } from '@microsoft/sp-http';

export interface ILocalizedWebPartProps {
  //description: string;
}

export default class LocalizedWebPart extends BaseClientSideWebPart<ILocalizedWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ILocalizedProps> = React.createElement(
      Localized,
      {
  ...
  protected onPropertyPaneConfigurationStart(): void {
    this.context.statusRenderer.displayLoadingIndicator(this.domElement, 'Loading language');
